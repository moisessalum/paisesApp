...
//
//   const capital = Convert.toCapital(json);
//
...
const typeMap: any = {
    ...
    "NativeName": o([
        { json: "nno", js: "nno", typ: r("Translation") },
        { json: "nob", js: "nob", typ: r("Translation") },
        { json: "smi", js: "smi", typ: r("Translation") },
    ], false),
    "Translation": o([
        { json: "official", js: "official", typ: "" },
        { json: "common", js: "common", typ: "" },
